...
import de.othr.securityproject.config.jwt.JwtAuthenticationFilter;
	   ...
	   @Autowired
	    ...
	    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
	    	...
	    	http.authorizeHttpRequests(rQ -> {
	            ...
	            rQ.requestMatchers("/api/register", "/api/authenticate").permitAll();
	            rQ.requestMatchers("/home", "/login", "/grantcode").permitAll();
